export default [
  {
    ...
    "description": "Savory beef rice noodles topped with saut\u00e9ed spinach, soft egg ribbons, sweet bell peppers, and mushrooms.",
    "ingredients_sec": [
      {
        "_id": "jd-R1I1",
        "title": "Noodles",
  ...
  },
  {
    ...
    "description": "Miscellaneous | British",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "description": "Breakfast | Canadian",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "description": "Vegetarian | Ukrainian",
    "ingredients_sec": [
      {
    ...
    "ingredients_sec": [
      {
        ...
        "ingredients": [
          ...
          "salt (1 tsp)",
          "chicken breast (3 diced)",
          "olive oil (2 tbsp)",
          "onion (1 small finely diced)",
          "red pepper (2 finely diced)",
          "garlic (2 cloves minced)",
  ...
  },
  {
    ...
    "description": "Vegetarian | Mexican",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "description": "Miscellaneous | Jamaican",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Chakchouka ",
    "description": "Miscellaneous | Tunisian",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "description": "Vegetarian | Filipino",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "description": "Vegetarian | Russian",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Duck Confit",
    "description": "Miscellaneous | French",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Egg Drop Soup",
    "description": "Vegetarian | Chinese",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "description": "Breakfast | American",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Ful Medames",
    "description": "Vegetarian | Egyptian",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Fish fofos",
    "description": "Seafood | Portuguese",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      "(Transfer from the baking sheet by scooting your hand or a spatula under each piece of mac and cheese and then flipping it over onto a sandwich.) Place 1 slice of Jack on top of each",
  ...
  },
  {
    ...
    "steps": [
      "STEP 1",
      "Put all of the ingredients, except the sardines, into a bowl and mix together with some seasoning",
  ...
  },
  {
    ...
    "steps": [
      ...
      "In a microwave-safe bowl, combine the dark chocolate chips, heavy cream and half of the sweetened condensed milk",
      "Microwave the dark chocolate mixture in 20-second intervals, stirring in between each interval, until the chocolate is melted",
      ...
      "In a separate bowl, combine the white chocolate chips with the remaining half of the sweetened condensed milk",
      "Microwave the white chocolate mixture in 20-second intervals, stirring in between each interval, until the chocolate is melted",
      ...
      "Carefully peel all of the wax paper from the fudge",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Heat oil in a pan and fry the strips for 6 minutes until it's ready",
      "Bake the fries until golden brown in a deep fryrer",
      "When ready transfer to a backing dish",
      "Make sure the fries are spread over the whole dish",
      "Cover the fries with a new layer of meat and spread evenly",
      "Add a layer of cheese over the meat",
      "You can also use grated cheese",
      "When done put in the oven for a few minutes until the cheese is melted",
      "Chop the lettuce, tomato and cucumber in small pieces and mix together",
      "for a basic salad",
      "As extra you can add olives jalapenos and a red union",
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Kafteji",
    "description": "Vegetarian | Tunisian",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "steps": [
      "In a small bowl, combine the first four ingredients; spread on four slices of bread",
      "Layer with bacon, tomato and cheese; top with remaining bread",
      "In a large skillet or griddle, melt 2 tablespoons butter",
      "Toast sandwiches until lightly browned on both sides and cheese is melted, adding butter if necessary",
      "Nutrition Facts",
  ...
  },
  {
    ...
    "description": "Vegetarian | British",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "steps": [
      "STEP 1",
      "Boil the potatoes for 15 mins or until tender",
      "Drain, then mash",
      "STEP 2",
      ...
      "Fold into the mash and serve",
      "Great with gammon or to top a fish pie."
    ],
    "tags": [],
  ...
  },
  {
    ...
    "description": "Vegetarian | Moroccan",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Migas",
    "description": "Miscellaneous | Spanish",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "description": "Miscellaneous | Italian",
    "ingredients_sec": [
      {
    ...
    "steps": [
      ...
      "Dredging the shanks: pour the flour into a shallow dish (a pie plate works nicely)",
      ...
      "The aromatics: pour off and discard the fat from the pot",
      "Wipe out any burnt bits with a damp paper towel, being careful not to remove any delicious little caramelized bits",
      "Ad the remaining 2 tablespoons butter to the pot and melt it over medium heat",
      "When the butter has stopped foaming, add the onion, carrot, celery, and fennel",
      "Season with salt and pepper, stir, and cook the vegetables until they begin to soften but do not brown, about 6 minutes",
      "Stir in the garlic, orange zest, marjoram, and bay leaf, and stew for another minute or two",
      "The braising liquid: add the wine, increase the heat to high, and bring to a boil",
      "Boil, stirring occasionally, to reduce the wine by about half, 5 minutes",
      "Add the stock and tomatoes, with their juice, and boil again to reduce the liquid to about 1 cup total, about 10 minutes",
      "The braise: Place the shanks in the pot so that they are sitting with the exposed bone facing up, and pour over any juices that accumulated as they sat",
      "Cover with parchment paper, pressing down so the parchment nearly touches the veal and the edges hang over the sides of the pot by about an inch",
      "Cover tightly with the lid, and slide into the lower part of the oven to braise at a gentle simmer",
      "Check the pot after the first 15 minutes, and if the liquid is simmering too aggressively, lower the oven heat by 10 or 15 degrees",
      ...
      "The gremolata: While the shanks are braising, stir together the garlic, parsley, and lemon zest in a small bowl",
      "Cover with plastic wrap and set aside in a cool place (or the refrigerator, if your kitchen is very warm.)",
      "The finish: When the veal is fork-tender and falling away from the bone, remove the lid and sprinkle over half of the gremolata",
      ...
      "If it tastes a bit weak or flat, bring it to a boil over high heat, and boil to reduce the volume and intensify the flavor for 5 to 10 minutes",
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Poutine",
    "description": "Miscellaneous | Canadian",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      "At this point, mix in the butter or the vegetable oil",
      "Alternatively, you can use them to grease the pan before frying each pancake",
      ...
      "Transfer to a plate",
      "Cook the remaining batter until all used up",
  ...
  },
  {
    ...
    "description": "Chicken | Portuguese",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "description": "Dessert | Portuguese",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Ribollita",
    "description": "Vegetarian | Italian",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      "Grease a 10x14x2-inch baking pan",
  ...
  },
  {
    ...
    "steps": [
      "In a medium bowl mix egg yolks, philly cheese and baking powder using a hand held mixer",
    ...
    "ingredients_sec": [
      {
        ...
        "ingredients": [
          ...
          "white wine (125ml)",
          "vegetable stock (1 litre hot)",
          "lemon (The juice and zest of one)",
          "King Prawns (240g large)",
          "salmon (150g)",
          "asparagus (100g tips blanched briefly in boiling water)",
          "black pepper (ground)",
          "Parmesan (50g shavings)"
        ]
      }
    ],
    "steps": [
  ...
  },
  {
    ...
    "description": "Vegetarian | Spanish",
    "ingredients_sec": [
      {
  ...
  },
  {
    ...
    "steps": [
      ...
      "Pour in the starchy sauce",
      "Stir-fry all the ingredients until the pork and sauce are thoroughly mixed together",
  ...
  },
  {
    ...
    "steps": [
      ...
      "(For 4, spread meatloaves out across whole sheet and add carrots to a second sheet.) Bake for 20 minutes (we'll glaze the meatloaves then)",
      "Meanwhile, place potatoes in a medium pot with enough salted water to cover by 2 inches",
      "Bring to a boil and cook until very",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Add the butter and process until the mixture resembles coarse",
      ...
      "(To prevent the pastry from sticking to the counter and to ensure uniform thickness, keep lifting up and turning the pastry a quarter turn as you roll (always roll from the center of the pastry outwards).)  Fold the dough in half and gently transfer to a 9 inch (23 cm) pie pan",
      "Brush off any excess flour and trim any overhanging pastry to an edge of 1/2 inch (1.5 cm)",
      ...
      "Make the Strawberry Rhubarb Filling: Place the cut strawberries and rhubarb in a large bowl",
      "In a small bowl mix together the cornstarch, sugar, and ground cinnamon",
      "Remove the chilled pie crust from the fridge",
      "Sprinkle about 2 tablespoons of the sugar mixture over the bottom of the pastry crust",
      "Add the remaining sugar mixture to the strawberries and rhubarb and gently toss to combine",
      "Pour the fruit mixture into the prepared pie shell",
      "Sprinkle the fruit with about 1 teaspoon of lemon juice and dot with 2 tablespoons of butter",
      ...
      "Brush the lattice pastry with milk and sprinkle with a little sugar",
      "Cover and place in the refrigerator while you preheat the oven to 400 degrees F (205 degrees C) and place the oven rack in the lower third of the oven",
      "Put a baking sheet, lined with aluminum foil, on the oven rack (to catch any spills.)",
      "Place the pie plate on the hot baking sheet and bake the pie for about 35 minutes and then, if the edges of the pie are browning too much, cover with a foil ring",
      "Continue to bake the pie for about another 10 minutes or until the crust is a golden brown color and the fruit juices begin to bubble",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Just before serving, in a large mixing bowl, combine 1 cup cold heavy cream and 1/4 cup powdered sugar, and beat with an electric mixer until stiff peaks form",
  ...
  },
  {
    ...
    "steps": [
      ...
      "Gradually beat in the semi-skimmed milk",
      "Season",
      "Put the sausages into the hot roasting tray and pour over the batter",
      "Top with cherry tomatoes on the vine and cook for 30 minutes until puffed and golden."
    ],
    "tags": [],
  ...
  },
  {
    ...
    "steps": [
      ...
      "Egg wash the pastry and set aside to chill in the fridge (the cling film makes it easier to move about)",
      "Do not cut into strips at this stage",
      "Do not egg wash the strips once they are on the tart as it will drip into the treacle mixture",
      ...
      "Bake on the pre-heated baking tray in the hot oven for about 10 minutes until the pastry has started to colour, and then reduce the oven temperature to 180C/350F/Gas 4",
      "If at this stage the lattice seems to be getting too dark brown, cover the tart with tin foil",
  ...
  },
  {
    ...
    "steps": [
      "Mix all the ingredients for the dough together and knead well",
      "Cover the dough and put to rise until doubled in size which should take about 2 hours",
      "Knock back the dough and knead lightly",
      "Divide the dough into two equal pieces; roll each piece into an oblong about 12 inches by 8 inches",
      "Mix the filling ingredients together and divide between the dough, spreading over each piece",
      ...
      "Sift with a generous covering of icing sugar."
    ],
    "tags": [
      "Nutty"
    ],
  ...
  },
  {
    ...
    "user_created": "recipeBot",
    "name": "Yaki Udon",
    "description": "Vegetarian | Japanese",
    "ingredients_sec": [
      {
